...
class Api {
  ...
  */
  ...
  gb_create_assignment(input, callback) { // POST
    let path = `${this.baseURL}/GBService/${this.district}/Assignment`;
    postRequest({path: path, body: input}, (err, data) => { callback(dataCallback(err, data))});
  }

  gb_save_assignment(input, callback) { // PUT
    let path = `${this.baseURL}/GBService/${this.district}/Assignment`;
    putRequest({path: path, body: input}, (err, data) => { callback(dataCallback(err, data))});
  }
  ...
  gb_get_assignment_score_by_assignment_student(staffId, callback) { // GET
    let path = `${this.baseURL}/GBService/${this.district}/AssignmentScore?TeacherID=${staffId}`;
    getRequest(path, (err, data) => { callback(dataCallback(err, data))});
  }
  ...
  gb_create_assignment_score(input, callback) { // POST
    let path = `${this.baseURL}/GBService/${this.district}/AssignmentScore`;
    postRequest({path: path, body: input}, (err, data) => { callback(dataCallback(err, data))});
  }

  gb_save_assignment_score(input, callback) { // PUT
    let path = `${this.baseURL}/GBService/${this.district}/AssignmentScore`;
    putRequest({path: path, body: input}, (err, data) => { callback(dataCallback(err, data))});
  }
  ...
  gb_create_assignment_type(input, callback) { // POST
    let path = `${this.baseURL}/GBService/${this.district}/ AssignmentType`;
    postRequest({path: path, body: input}, (err, data) => { callback(dataCallback(err, data))});
  }

  gb_save_assignment_type(input, callback) { // PUT
    let path = `${this.baseURL}/GBService/${this.district}/AssignmentType`;
    putRequest({path: path, body: input}, (err, data) => { callback(dataCallback(err, data))});
  }
  ...
  */
  ...
  create_discipline_incident(input, callback) { // POST 
    let path = `${this.baseURL}/SisService/DisciplineIncident`;
    postRequest({path: path, body: input}, (err, data) => { callback(dataCallback(err, data))});
  }

  update_discipline_incident(input, callback) { // PUT
    let path = `${this.baseURL}/SisService/DisciplineIncident`;
    putRequest({path: path, body: input}, (err, data) => { callback(dataCallback(err, data))});
  }
  ...
  create_student_daily_attendance(input, callback) { // POST
    let path = `${this.baseURL}/SisService/StudentDailyAttendance`;
    postRequest({path: path, body: input}, (err, data) => { callback(dataCallback(err, data))});
  }

  update_Student_daily_attendance(input, callback) { // PUT
    let path = `${this.baseURL}/SisService/StudentDailyAttendance`;
    putRequest({path: path, body: input}, (err, data) => { callback(dataCallback(err, data))});
  }
...
function postRequest(input, callback) {
  request.post(constructPayload({payload: input, path: input.path, reqType: 'POST'}), function(err, res, body) {
...
function putRequest(input, callback) {
  request.put(constructPayload({payload: input.body, path: input.path, reqType: 'PUT'}), function(err, res, body) {
    if (!err && res.statusCode === 200) {
      callback(null, body);
    } else {
      callback({error: err, body: body});
